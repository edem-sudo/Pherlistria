export const random = {
  ...
  uniformFn(range){ // 그냥 숫자 하나 반환하는거 말고 함수 필요할때 쓸것.
    return () => this.uniform(range);
  },

  chance(p){ // 균등분포, 0~1 사이 확률 p로 true, 아니면 false를 반환함.
    return this.uniform() < p;
  },
  chanceFn(p){ // 그냥 숫자 하나 반환하는거 말고 함수 필요할때 쓸것.
  ...
  intFn(min, max){ // 그냥 숫자 하나 반환하는거 말고 함수 필요할때 쓸것.
  ...
  normalFn(mean, stddev, min, max){ // 그냥 숫자 하나 반환하는거 말고 함수 필요할때 쓸것.
